...
namespace Papyrus
{
	...
	{
		inline RE::TESForm* Get(const RE::BGSDefaultObject& a_self)
		{
			return a_self.form;
		}

		inline RE::TESForm* GetDefaultObject(std::monostate, std::string_view a_editorID)
		{
			return RE::TESForm::GetFormByEditorID(a_editorID);
		}

		inline void Set(RE::BGSDefaultObject& a_self, RE::TESForm* a_newForm)
		{
